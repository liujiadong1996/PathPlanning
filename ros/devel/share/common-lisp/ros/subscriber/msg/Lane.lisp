...
(cl:defclass <Lane> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (waypoints
    :reader waypoints
    :initarg :waypoints
    :type (cl:vector subscriber-msg:Waypoint)
   :initform (cl:make-array 0 :element-type 'subscriber-msg:Waypoint :initial-element (cl:make-instance 'subscriber-msg:Waypoint)))
   (lane_index
    :reader lane_index
    :initarg :lane_index
    :type cl:integer
...
(cl:defmethod cl:initialize-instance :after ((m <Lane>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Lane)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name subscriber-msg:<Lane> is deprecated: use subscriber-msg:Lane instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Lane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader subscriber-msg:header-val is deprecated.  Use subscriber-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'increment-val :lambda-list '(m))
(cl:defmethod increment-val ((m <Lane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader subscriber-msg:increment-val is deprecated.  Use subscriber-msg:increment instead.")
  (increment m))
...
(cl:defmethod waypoints-val ((m <Lane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader subscriber-msg:waypoints-val is deprecated.  Use subscriber-msg:waypoints instead.")
  (waypoints m))

(cl:ensure-generic-function 'lane_index-val :lambda-list '(m))
(cl:defmethod lane_index-val ((m <Lane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader subscriber-msg:lane_index-val is deprecated.  Use subscriber-msg:lane_index instead.")
  (lane_index m))
...
(cl:defmethod closest_object_distance-val ((m <Lane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader subscriber-msg:closest_object_distance-val is deprecated.  Use subscriber-msg:closest_object_distance instead.")
...
(cl:defmethod closest_object_velocity-val ((m <Lane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader subscriber-msg:closest_object_velocity-val is deprecated.  Use subscriber-msg:closest_object_velocity instead.")
  (closest_object_velocity m))

(cl:ensure-generic-function 'is_blocked-val :lambda-list '(m))
(cl:defmethod is_blocked-val ((m <Lane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader subscriber-msg:is_blocked-val is deprecated.  Use subscriber-msg:is_blocked instead.")
  (is_blocked m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Lane>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'waypoints)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'subscriber-msg:Waypoint))
