...
(cl:defclass <LaneArray> (roslisp-msg-protocol:ros-message)
  ((id
   ...
   (lanes
    :reader lanes
    :initarg :lanes
    :type (cl:vector subscriber-msg:Lane)
   :initform (cl:make-array 0 :element-type 'subscriber-msg:Lane :initial-element (cl:make-instance 'subscriber-msg:Lane))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <LaneArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LaneArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name subscriber-msg:<LaneArray> is deprecated: use subscriber-msg:LaneArray instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <LaneArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader subscriber-msg:id-val is deprecated.  Use subscriber-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'lanes-val :lambda-list '(m))
(cl:defmethod lanes-val ((m <LaneArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader subscriber-msg:lanes-val is deprecated.  Use subscriber-msg:lanes instead.")
  (lanes m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LaneArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'lanes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'subscriber-msg:Lane))
