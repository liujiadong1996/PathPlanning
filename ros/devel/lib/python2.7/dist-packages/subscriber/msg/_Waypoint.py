...
"""autogenerated by genpy from subscriber/Waypoint.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['int32','int32','geometry_msgs/PoseStamped','geometry_msgs/TwistStamped','subscriber/DTLane','int32','subscriber/WaypointState','uint32','uint32','uint32','uint32','float32','float32','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.dtlane is None:
        self.dtlane = subscriber.msg.DTLane()
      if self.change_flag is None:
        self.change_flag = 0
      if self.wpstate is None:
        self.wpstate = subscriber.msg.WaypointState()
