// Generated by gencpp from file subscriber/Waypoint.msg
// DO NOT EDIT!


#ifndef SUBSCRIBER_MESSAGE_WAYPOINT_H
#define SUBSCRIBER_MESSAGE_WAYPOINT_H
...
#include <subscriber/DTLane.h>
#include <subscriber/WaypointState.h>
...
struct Waypoint_
{
  ...
  _twist_type twist;
   ...
   typedef  ::subscriber::DTLane_<ContainerAllocator>  _dtlane_type;
  _dtlane_type dtlane;

   typedef int32_t _change_flag_type;
  _change_flag_type change_flag;

   typedef  ::subscriber::WaypointState_<ContainerAllocator>  _wpstate_type;
  ...
  typedef boost::shared_ptr< ::subscriber::Waypoint_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::subscriber::Waypoint_<ContainerAllocator> const> ConstPtr;

}; // struct Waypoint_

typedef ::subscriber::Waypoint_<std::allocator<void> > Waypoint;

typedef boost::shared_ptr< ::subscriber::Waypoint > WaypointPtr;
typedef boost::shared_ptr< ::subscriber::Waypoint const> WaypointConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::subscriber::Waypoint_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::subscriber::Waypoint_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::subscriber::Waypoint_<ContainerAllocator1> & lhs, const ::subscriber::Waypoint_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::subscriber::Waypoint_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::subscriber::Waypoint_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::subscriber::Waypoint_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::subscriber::Waypoint_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::subscriber::Waypoint_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::subscriber::Waypoint_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::subscriber::Waypoint_<ContainerAllocator> >
{
  ...
  static const char* value(const ::subscriber::Waypoint_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xf980f8144ba8190eULL;
  static const uint64_t static_value2 = 0x8db52ab486d506e2ULL;
};

template<class ContainerAllocator>
struct DataType< ::subscriber::Waypoint_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::subscriber::Waypoint_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# global id\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::subscriber::Waypoint_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::subscriber::Waypoint_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::subscriber::Waypoint_<ContainerAllocator>& v)
  {
    s << indent << "gid: ";
    ...
    s << indent << "dtlane: ";
    s << std::endl;
    Printer< ::subscriber::DTLane_<ContainerAllocator> >::stream(s, indent + "  ", v.dtlane);
    s << indent << "change_flag: ";
    Printer<int32_t>::stream(s, indent + "  ", v.change_flag);
    s << indent << "wpstate: ";
    s << std::endl;
    Printer< ::subscriber::WaypointState_<ContainerAllocator> >::stream(s, indent + "  ", v.wpstate);
    s << indent << "lane_id: ";
...
#endif // SUBSCRIBER_MESSAGE_WAYPOINT_H
