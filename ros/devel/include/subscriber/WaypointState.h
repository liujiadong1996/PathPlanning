// Generated by gencpp from file subscriber/WaypointState.msg
// DO NOT EDIT!


#ifndef SUBSCRIBER_MESSAGE_WAYPOINTSTATE_H
#define SUBSCRIBER_MESSAGE_WAYPOINTSTATE_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::subscriber::WaypointState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::subscriber::WaypointState_<ContainerAllocator> const> ConstPtr;

}; // struct WaypointState_

typedef ::subscriber::WaypointState_<std::allocator<void> > WaypointState;

typedef boost::shared_ptr< ::subscriber::WaypointState > WaypointStatePtr;
typedef boost::shared_ptr< ::subscriber::WaypointState const> WaypointStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::subscriber::WaypointState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::subscriber::WaypointState_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::subscriber::WaypointState_<ContainerAllocator1> & lhs, const ::subscriber::WaypointState_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::subscriber::WaypointState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::subscriber::WaypointState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::subscriber::WaypointState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::subscriber::WaypointState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::subscriber::WaypointState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::subscriber::WaypointState_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::subscriber::WaypointState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::subscriber::WaypointState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x623a0ffbb0a05249ULL;
  static const uint64_t static_value2 = 0x0adc981c2a3e8eddULL;
};

template<class ContainerAllocator>
struct DataType< ::subscriber::WaypointState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::subscriber::WaypointState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "int32 aid\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::subscriber::WaypointState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::subscriber::WaypointState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::subscriber::WaypointState_<ContainerAllocator>& v)
  {
    s << indent << "aid: ";
...
#endif // SUBSCRIBER_MESSAGE_WAYPOINTSTATE_H
