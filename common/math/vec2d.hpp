...
class Vec2d {
 public:
  ...
  // Get the angle between the vector and the positive x semi-axis
  double Angle() const;
  ...
  // Substracs another Vec2d to the current one
  Vec2d &operator-=(const Vec2d &other);

  // Mutiplies this Vec2d by a scalar
